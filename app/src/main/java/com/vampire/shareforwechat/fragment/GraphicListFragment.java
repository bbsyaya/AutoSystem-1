...
public class GraphicListFragment extends AppBaseFragment implements OnSubitemClickListener, View.OnClickListener {
    private static final String TAG = "GraphicListFragment";
...
//        Log.e(TAG, "onResponse: " + strReuslt);
    ...
    public static GraphicListFragment newInstance(String labelId) {
        GraphicListFragment fragment = new GraphicListFragment();
