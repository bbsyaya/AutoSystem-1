...
public class LocationHook {
    ...
    public static Location getLocation() {
        ...
        XSharedPreferences xsp = new XSharedPreferences("com.rabbit.fans", "markypq");
        double latitude = Double.valueOf(xsp.getString("lat", "0"));
//        double longtitude = Double.valueOf(xsp.getString("lon","0"))+ (double) new Random().nextInt(1000) / 1000000  ;
        double longtitude = Double.valueOf(xsp.getString("lon", "0"));
